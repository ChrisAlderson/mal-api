...
module.exports = class Item {
   ...
   * @returns {Promise<Array<Object>, Error>} - The promise to search for
   * content.
   */
  search(type, q) {
   ...
   * @param {!Object} data - The data to add the content with.
   * @returns {Promise<string, Error>} - A promise to add content.
   */
   ...
   * @param {!Object} data - The data to update the content with.
   * @returns {Promise<string, Error>} - A promise to update content.
   */
   ...
   * @returns {Promise<string, Error>} - A promise to delete content.
   */
  deleteItem(type, id) {
