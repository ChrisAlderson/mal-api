...
module.exports = class Anime extends Item {
   ...
   * @returns {Promise<Array<Anime>, Error>} - The promise to search for an
   * anime.
   */
  searchAnime(title) {
   ...
   * @returns {Promise<string, Error>} - A promise to add an anime.
   */
  addAnime(id, data) {
   ...
   * @returns {Promise<string, Error>} - A promise to update an anime.
   */
  updateAnime(id, data) {
   ...
   * @returns {Promise<string, Error>} - A promise to delete an anime.
   */
  deleteAnime(id) {
